...
class ColorTheme {
  ...
  static const Color backgroundSubColor = Color(0xffdfdfdf);

  static const Color itemMainColor = Color(0xffdfdfdf);
  static const Color itemSubColor = Color(0xff000000);
  ...
  static const Color buttonMainColor = Color(0xffdfdfdf);
}